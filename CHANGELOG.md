...
- Create and manage profiles for request and response header rules, with pause controls, notes and rule duplication.
- Scope profiles by URL, resource type, current site or browser tab.
